/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: b0b3c93accccf83b916f21898765fa27)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		NEXT_STATIC_HOST: "https://hacker-podcast-worker.neoy.workers.dev/static";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_STATIC_HOST">> {}
}
