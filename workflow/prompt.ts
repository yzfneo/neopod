...
【主播设定】
- 主播（小濛）：资深科技编辑背景，既能用通俗易懂的比喻解释复杂概念，也能提供深刻的技术洞察和行业背景。她的风格亲切、专业、且富有感染力。
...
女：今天咱们来聊几个挺有意思的话题。首先是一个关于...的事儿。简单来说就是...

女：其实这种技术的核心在于... 就像是我们平时...

女：好了，以上就是今天的全部内容，感谢收听。大家可以订阅我们的节目，我们下期再见。
`.trim()
