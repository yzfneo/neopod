...
【长度控制 - 重要】
- 全文总长度控制在 2000-2400 个字符（约 8-10 分钟朗读时长）
- 每篇文章用 180-220 字介绍，精炼但有实质内容
- 每个话题覆盖 2 个关键要点：核心观点 + 1 个具体细节或案例
- 开场白和结束语各控制在 100-120 字
- 用具体例子和场景让内容生动，避免泛泛而谈
- 如果内容太多，优先保证每个话题都有案例支撑
