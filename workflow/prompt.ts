...
【长度控制 - 重要】
- 全文总长度控制在 3000-3500 个字符（约 6-8 分钟朗读时长，最长不超过 10 分钟）
- 每篇文章用 280-350 字介绍，确保充分覆盖核心内容
- 每篇文章必须覆盖：核心观点 + 至少 2 个具体细节/案例/技术要点
- 开场白和结束语各控制在 120-150 字
- 用具体例子、数据对比和场景描述让内容生动，避免泛泛而谈
- 必须覆盖所有输入的文章，不能遗漏任何一篇

【输出格式】
- 简练优雅的中文，专业术语可保留英文。
- 纯文本，不使用 Markdown。
- 确保总字符数在 3000-3500 之间，必须覆盖所有文章。
